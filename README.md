...
This is a sample template for tesla-frunk-button - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name tesla-frunk-button --tail
```
...
```bash
aws cloudformation delete-stack --stack-name tesla-frunk-button
```
